...
import type { CountEvents200ResponseData } from './CountEvents200ResponseData';
import {
    CountEvents200ResponseDataFromJSON,
    CountEvents200ResponseDataFromJSONTyped,
    CountEvents200ResponseDataToJSON,
} from './CountEvents200ResponseData';
...
export interface CountEvents200Response {
    /**
     * 
     * @type {CountEvents200ResponseData}
     * @memberof CountEvents200Response
     */
    data?: CountEvents200ResponseData;
    /**
     * 
...
export function CountEvents200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountEvents200Response {
    ...
    return {
        ...
        'data': !exists(json, 'data') ? undefined : CountEvents200ResponseDataFromJSON(json['data']),
...
export function CountEvents200ResponseToJSON(value?: CountEvents200Response | null): any {
    ...
    return {
        ...
        'data': CountEvents200ResponseDataToJSON(value.data),
