...
export class BillingApi extends runtime.BaseAPI {
     ...
     */
    async upsertBillingProductRaw(requestParameters: UpsertBillingProductRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UpsertBillingProductResponse>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: CreateBillingProductRequestBodyToJSON(requestParameters['createBillingProductRequestBody']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => UpsertBillingProductResponseFromJSON(jsonValue));
    }

    /**
     * Upsert billing product
     */
    async upsertBillingProduct(requestParameters: UpsertBillingProductRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UpsertBillingProductResponse> {
        const response = await this.upsertBillingProductRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async upsertBillingSubscriptionRaw(requestParameters: UpsertBillingSubscriptionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UpsertBillingSubscriptionResponse>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: CreateBillingSubscriptionsRequestBodyToJSON(requestParameters['createBillingSubscriptionsRequestBody']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => UpsertBillingSubscriptionResponseFromJSON(jsonValue));
    }

    /**
     * Upsert billing subscription
     */
    async upsertBillingSubscription(requestParameters: UpsertBillingSubscriptionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UpsertBillingSubscriptionResponse> {
        const response = await this.upsertBillingSubscriptionRaw(requestParameters, initOverrides);
        return await response.value();
    }
