...
export class FeaturesApi extends runtime.BaseAPI {
   ...
   * Count flag checks
   */
  async countFlagChecksRaw(
    requestParameters: CountFlagChecksRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<CountFlagChecksResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      CountFlagChecksResponseFromJSON(jsonValue),
    );
  }
   ...
   * Count flag checks
   */
  async countFlagChecks(
    requestParameters: CountFlagChecksRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<CountFlagChecksResponse> {
    const response = await this.countFlagChecksRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * Get flag check
   */
  async getFlagCheckRaw(
    requestParameters: GetFlagCheckRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<GetFlagCheckResponse>> {
    ...
    const response = await this.request(
      {
        path: `/flag-checks/{flag_check_id}`.replace(
          `{${"flag_check_id"}}`,
          encodeURIComponent(String(requestParameters["flagCheckId"])),
        ),
        method: "GET",
        headers: headerParameters,
        query: queryParameters,
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      GetFlagCheckResponseFromJSON(jsonValue),
    );
  }
  ...
  async getFlagCheck(
    requestParameters: GetFlagCheckRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<GetFlagCheckResponse> {
    const response = await this.getFlagCheckRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async getLatestFlagChecksRaw(
    requestParameters: GetLatestFlagChecksRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<GetLatestFlagChecksResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      GetLatestFlagChecksResponseFromJSON(jsonValue),
    );
  }
   ...
   * Get latest flag checks
   */
  async getLatestFlagChecks(
    requestParameters: GetLatestFlagChecksRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<GetLatestFlagChecksResponse> {
    const response = await this.getLatestFlagChecksRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * List flag checks
   */
  async listFlagChecksRaw(
    requestParameters: ListFlagChecksRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ListFlagChecksResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ListFlagChecksResponseFromJSON(jsonValue),
    );
  }
   ...
   * List flag checks
   */
  async listFlagChecks(
    requestParameters: ListFlagChecksRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ListFlagChecksResponse> {
    const response = await this.listFlagChecksRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
