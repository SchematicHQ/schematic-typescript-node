 ...
 */
export function instanceOfListCompanyPlansResponse(
  value: object,
): value is ListCompanyPlansResponse {
  if (!("data" in value) || value["data"] === undefined) return false;
  if (!("params" in value) || value["params"] === undefined) return false;
  return true;
}

export function ListCompanyPlansResponseFromJSON(
  json: any,
): ListCompanyPlansResponse {
  return ListCompanyPlansResponseFromJSONTyped(json, false);
}

export function ListCompanyPlansResponseFromJSONTyped(
  json: any,
...
export function ListCompanyPlansResponseToJSON(
  value?: ListCompanyPlansResponse | null,
): any {
  if (value == null) {
    return value;
  }
