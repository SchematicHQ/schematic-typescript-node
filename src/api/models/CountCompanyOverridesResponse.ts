 ...
 */
export function instanceOfCountCompanyOverridesResponse(value: object): boolean {
    if (!('data' in value)) return false;
    if (!('params' in value)) return false;
    return true;
}

export function CountCompanyOverridesResponseFromJSON(json: any): CountCompanyOverridesResponse {
    return CountCompanyOverridesResponseFromJSONTyped(json, false);
}

export function CountCompanyOverridesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountCompanyOverridesResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function CountCompanyOverridesResponseToJSON(value?: CountCompanyOverridesResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
