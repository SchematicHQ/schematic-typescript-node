...
export function GetAudienceResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetAudienceResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function GetAudienceResponseToJSON(value?: GetAudienceResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
