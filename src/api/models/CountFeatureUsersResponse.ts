...
export function CountFeatureUsersResponseFromJSON(json: any): CountFeatureUsersResponse {
    return CountFeatureUsersResponseFromJSONTyped(json, false);
}

export function CountFeatureUsersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountFeatureUsersResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function CountFeatureUsersResponseToJSON(value?: CountFeatureUsersResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
