...
export function CountCompaniesResponseFromJSON(json: any): CountCompaniesResponse {
    return CountCompaniesResponseFromJSONTyped(json, false);
}

export function CountCompaniesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountCompaniesResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function CountCompaniesResponseToJSON(value?: CountCompaniesResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
