 ...
 */
export function instanceOfRuleConditionDetailResponseData(value: object): boolean {
...
export function RuleConditionDetailResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuleConditionDetailResponseData {
    ...
    return {
        ...
        'resources': ((json['resources'] as Array<any>).map(RuleConditionResourceResponseDataFromJSON)),
        'ruleId': json['rule_id'],
...
export function RuleConditionDetailResponseDataToJSON(value?: RuleConditionDetailResponseData | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'resources': ((value['resources'] as Array<any>).map(RuleConditionResourceResponseDataToJSON)),
