 ...
 */
export function instanceOfEntityTraitDetailResponseData(value: object): boolean {
...
export function EntityTraitDetailResponseDataToJSON(value?: EntityTraitDetailResponseData | null): any {
    if (value == null) {
        return value;
    }
    return {
