...
export function CountFeatureUsageResponseFromJSON(json: any): CountFeatureUsageResponse {
    return CountFeatureUsageResponseFromJSONTyped(json, false);
}

export function CountFeatureUsageResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountFeatureUsageResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function CountFeatureUsageResponseToJSON(value?: CountFeatureUsageResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
