 ...
 */
export function instanceOfCountEntityKeyDefinitionsResponse(value: object): boolean {
    if (!('data' in value)) return false;
    if (!('params' in value)) return false;
    return true;
}

export function CountEntityKeyDefinitionsResponseFromJSON(json: any): CountEntityKeyDefinitionsResponse {
    return CountEntityKeyDefinitionsResponseFromJSONTyped(json, false);
}

export function CountEntityKeyDefinitionsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountEntityKeyDefinitionsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function CountEntityKeyDefinitionsResponseToJSON(value?: CountEntityKeyDefinitionsResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
