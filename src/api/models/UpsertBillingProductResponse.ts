...
export function UpsertBillingProductResponseFromJSON(json: any): UpsertBillingProductResponse {
    return UpsertBillingProductResponseFromJSONTyped(json, false);
}

export function UpsertBillingProductResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpsertBillingProductResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function UpsertBillingProductResponseToJSON(value?: UpsertBillingProductResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
