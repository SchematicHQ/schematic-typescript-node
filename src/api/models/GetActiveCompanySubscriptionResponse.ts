 ...
 */
export function instanceOfGetActiveCompanySubscriptionResponse(value: object): boolean {
    if (!('data' in value)) return false;
    if (!('params' in value)) return false;
    return true;
}

export function GetActiveCompanySubscriptionResponseFromJSON(json: any): GetActiveCompanySubscriptionResponse {
    return GetActiveCompanySubscriptionResponseFromJSONTyped(json, false);
}

export function GetActiveCompanySubscriptionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetActiveCompanySubscriptionResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(CompanySubscriptionResponseDataFromJSON)),
        'params': GetActiveCompanySubscriptionParamsFromJSON(json['params']),
    };
}

export function GetActiveCompanySubscriptionResponseToJSON(value?: GetActiveCompanySubscriptionResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'data': ((value['data'] as Array<any>).map(CompanySubscriptionResponseDataToJSON)),
