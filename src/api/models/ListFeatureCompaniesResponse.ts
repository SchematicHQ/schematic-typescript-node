 ...
 */
export function instanceOfListFeatureCompaniesResponse(value: object): boolean {
    if (!('data' in value)) return false;
    if (!('params' in value)) return false;
    return true;
}

export function ListFeatureCompaniesResponseFromJSON(json: any): ListFeatureCompaniesResponse {
    return ListFeatureCompaniesResponseFromJSONTyped(json, false);
}

export function ListFeatureCompaniesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListFeatureCompaniesResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ListFeatureCompaniesResponseToJSON(value?: ListFeatureCompaniesResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
