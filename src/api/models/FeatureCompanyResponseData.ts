...
export function FeatureCompanyResponseDataFromJSON(json: any): FeatureCompanyResponseData {
    return FeatureCompanyResponseDataFromJSONTyped(json, false);
}

export function FeatureCompanyResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): FeatureCompanyResponseData {
    if (json == null) {
        return json;
    }
    return {
...
export function FeatureCompanyResponseDataToJSON(value?: FeatureCompanyResponseData | null): any {
    if (value == null) {
        return value;
    }
    return {
