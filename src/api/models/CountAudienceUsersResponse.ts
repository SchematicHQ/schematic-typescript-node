...
export function CountAudienceUsersResponseFromJSON(json: any): CountAudienceUsersResponse {
    return CountAudienceUsersResponseFromJSONTyped(json, false);
}

export function CountAudienceUsersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountAudienceUsersResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function CountAudienceUsersResponseToJSON(value?: CountAudienceUsersResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
