...
export function GetLatestFlagChecksParamsFromJSON(
  json: any,
): GetLatestFlagChecksParams {
  return GetLatestFlagChecksParamsFromJSONTyped(json, false);
}

export function GetLatestFlagChecksParamsFromJSONTyped(
  json: any,
...
export function GetLatestFlagChecksParamsToJSON(
  value?: GetLatestFlagChecksParams | null,
): any {
  if (value == null) {
    return value;
  }
