 ...
 */
export function instanceOfEntityKeyDetailResponseData(value: object): boolean {
...
export function EntityKeyDetailResponseDataToJSON(value?: EntityKeyDetailResponseData | null): any {
    if (value == null) {
        return value;
    }
    return {
