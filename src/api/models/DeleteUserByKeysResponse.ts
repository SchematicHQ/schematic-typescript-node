...
export function DeleteUserByKeysResponseFromJSON(json: any): DeleteUserByKeysResponse {
    return DeleteUserByKeysResponseFromJSONTyped(json, false);
}

export function DeleteUserByKeysResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteUserByKeysResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function DeleteUserByKeysResponseToJSON(value?: DeleteUserByKeysResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
