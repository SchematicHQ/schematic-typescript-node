 ...
 */
export function instanceOfUpsertUserResponse(value: object): boolean {
...
export function UpsertUserResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpsertUserResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function UpsertUserResponseToJSON(value?: UpsertUserResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
