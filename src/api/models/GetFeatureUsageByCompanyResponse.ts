 ...
 */
export function instanceOfGetFeatureUsageByCompanyResponse(value: object): boolean {
    if (!('data' in value)) return false;
    if (!('params' in value)) return false;
    return true;
}

export function GetFeatureUsageByCompanyResponseFromJSON(json: any): GetFeatureUsageByCompanyResponse {
    return GetFeatureUsageByCompanyResponseFromJSONTyped(json, false);
}

export function GetFeatureUsageByCompanyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetFeatureUsageByCompanyResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function GetFeatureUsageByCompanyResponseToJSON(value?: GetFeatureUsageByCompanyResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
