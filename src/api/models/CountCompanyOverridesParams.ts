...
export function CountCompanyOverridesParamsFromJSON(json: any): CountCompanyOverridesParams {
    return CountCompanyOverridesParamsFromJSONTyped(json, false);
}

export function CountCompanyOverridesParamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountCompanyOverridesParams {
    if (json == null) {
        return json;
    }
    return {
...
export function CountCompanyOverridesParamsToJSON(value?: CountCompanyOverridesParams | null): any {
    if (value == null) {
        return value;
    }
    return {
