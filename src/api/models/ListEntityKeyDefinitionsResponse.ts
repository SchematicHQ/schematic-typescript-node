 ...
 */
export function instanceOfListEntityKeyDefinitionsResponse(value: object): boolean {
    if (!('data' in value)) return false;
    if (!('params' in value)) return false;
    return true;
}

export function ListEntityKeyDefinitionsResponseFromJSON(json: any): ListEntityKeyDefinitionsResponse {
    return ListEntityKeyDefinitionsResponseFromJSONTyped(json, false);
}

export function ListEntityKeyDefinitionsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListEntityKeyDefinitionsResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(EntityKeyDefinitionResponseDataFromJSON)),
        'params': ListEntityKeyDefinitionsParamsFromJSON(json['params']),
    };
}

export function ListEntityKeyDefinitionsResponseToJSON(value?: ListEntityKeyDefinitionsResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'data': ((value['data'] as Array<any>).map(EntityKeyDefinitionResponseDataToJSON)),
