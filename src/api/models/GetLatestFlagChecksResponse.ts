...
export function GetLatestFlagChecksResponseFromJSON(json: any): GetLatestFlagChecksResponse {
    return GetLatestFlagChecksResponseFromJSONTyped(json, false);
}

export function GetLatestFlagChecksResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetLatestFlagChecksResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function GetLatestFlagChecksResponseToJSON(value?: GetLatestFlagChecksResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
