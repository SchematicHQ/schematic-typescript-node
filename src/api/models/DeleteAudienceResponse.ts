...
export function DeleteAudienceResponseFromJSON(json: any): DeleteAudienceResponse {
    return DeleteAudienceResponseFromJSONTyped(json, false);
}

export function DeleteAudienceResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteAudienceResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function DeleteAudienceResponseToJSON(value?: DeleteAudienceResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
