...
export function CountFlagChecksResponseFromJSON(
  json: any,
): CountFlagChecksResponse {
  return CountFlagChecksResponseFromJSONTyped(json, false);
}

export function CountFlagChecksResponseFromJSONTyped(
  json: any,
...
export function CountFlagChecksResponseToJSON(
  value?: CountFlagChecksResponse | null,
): any {
  if (value == null) {
    return value;
  }
