 ...
 */
export function instanceOfCountPlanEntitlementsResponse(value: object): boolean {
    if (!('data' in value)) return false;
    if (!('params' in value)) return false;
    return true;
}

export function CountPlanEntitlementsResponseFromJSON(json: any): CountPlanEntitlementsResponse {
    return CountPlanEntitlementsResponseFromJSONTyped(json, false);
}

export function CountPlanEntitlementsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountPlanEntitlementsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function CountPlanEntitlementsResponseToJSON(value?: CountPlanEntitlementsResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
