...
export function UpsertCompanyTraitResponseFromJSON(json: any): UpsertCompanyTraitResponse {
    return UpsertCompanyTraitResponseFromJSONTyped(json, false);
}

export function UpsertCompanyTraitResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpsertCompanyTraitResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function UpsertCompanyTraitResponseToJSON(value?: UpsertCompanyTraitResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
