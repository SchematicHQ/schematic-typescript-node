 ...
 */
export function instanceOfFeatureUsageDetailResponseData(value: object): boolean {
...
export function FeatureUsageDetailResponseDataToJSON(value?: FeatureUsageDetailResponseData | null): any {
    if (value == null) {
        return value;
    }
    return {
