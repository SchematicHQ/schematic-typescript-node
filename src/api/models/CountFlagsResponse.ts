 ...
 */
export function instanceOfCountFlagsResponse(value: object): boolean {
...
export function CountFlagsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountFlagsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function CountFlagsResponseToJSON(value?: CountFlagsResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
